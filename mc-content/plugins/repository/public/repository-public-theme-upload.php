...
if(isset($_SESSION['username']))
{
   if(isset($_POST['upload']))
   {
      ...
      {
         move_uploaded_file($_FILES['file']['tmp_name'],"./uploads/themes/{$_FILES['file']['name']}");
	  ...
	  $mail->Body = "<p>
	  Hello team, a theme has been uploaded for review:<br><br>
	  <strong>Username:</strong> $user<br>
	  <strong>Type:</strong> Theme<br>
