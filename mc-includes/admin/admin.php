	...
	else
	{
		...
		*/
		...
		function all()
		{
			...
			while($row = $mcdb->fetch_assoc($result))
			{
				$module_name = $row['module_name'];
				$module_link = $row['module_link'];
				echo '<li><a href="/?p=manage&op='.$module_link.'"><img src="mc_includes/admin/images/'.$module_link.'.png" width="40" width="40"><br>'.$module_name.'</a></li>';
			}
			echo '</ul>';
			echo '<hr>';
			echo '<h3>Core Modules</h3>';
			echo '<ul>';
			echo '<li><a href="/?p=manage&op=blogs"><img src="mc_includes/admin/images/blogs.png" height="40" width="40"><br>Blogs</a></li>';
			echo '<li><a href="/?p=manage&op=modules"><img src="mc_includes/admin/images/modules.png" height="40" width="40"><br>Modules</a></li>';
			echo '<li><a href="/?p=manage&op=seo"><img src="mc_includes/admin/images/seo.png" width="40" width="40"><br>Settings</a></li>';
			echo '<li><a href="/?p=manage&op=version"><img src="mc_includes/admin/images/version.png" width="40" width="40"><br>Update</a></li>';
			echo '</ul>';
			echo '<br>';
			echo '</div>';
			echo '<br><br>';
		...
		function modules()
		{
			...
			while($rows = $db->fetch_assoc($result))
			{
				...
				{
					echo '<td>&nbsp;</td>';
					echo '<td><a href="/?page=manage&op=stop_module&id='.$module_id.'"><img src="mc_includes/admin/images/stop.png" height="30" width="30"></a></td>';
					echo '<td>&nbsp;</td>';
					echo '<td><a href="/?page=manage&op=drop_module&id='.$module_id.'"><img src="mc_includes/admin/images/delete.png" height="30" width="30"></a></td>';
				}
				elseif($status == 'In Active')
				{
					echo '<td><a href="/?page=manage&op=start_module&id='.$module_id.'"><img src="mc_includes/admin/images/plus.png" height="30" width="30"></a></td>';
					echo '<td>&nbsp;</td>';
					echo '<td>&nbsp;</td>';
					echo '<td><a href="/?page=manage&op=drop_module&id='.$module_id.'"><img src="mc_includes/admin/images/delete.png" height="30" width="30"></a></td>';
				}
				...
				{
					echo '<td><a href="/?p=manage&op=start_module&id='.$module_id.'"><img src="mc_includes/admin/images/plus.png" height="30" width="30"></a></td>';
					echo '<td>&nbsp;</td>';
					echo '<td><a href="/?page=manage&op=stop_module&id='.$module_id.'"><img src="mc_includes/admin/images/stop.png" height="30" width="30"></a></td>';
					echo '<td>&nbsp;</td>';
					echo '<td><a href="/?page=manage&op=drop_module&id='.$module_id.'"><img src="mc_includes/admin/images/delete.png" height="30" width="30"></a></td>';
			...
			if(isset($_POST['submit']))
			{
				...
				{
					$core->redirect_to("/?page=manage&op=modules");
				}
				
			}
			// Add Modules
			echo '<h3>Add a Module</h3>';
			echo '<form action="/?page=manage&op=modules" method="post">';
			...
			echo '<p><em>Please ensure you upload your admin image to the root mc_includes/admin/images/ folder, it must be in png format and named the same as your module.</em></p>';
		...
		function blogs()
		{
			...
			{	$id = $row['id'];
				...
				echo '<td>&nbsp;</td>';
				echo '<td><a href="/?page=manage&op=edit_blog&id='.$id.'" hreflang="en"><img src="/img/manage/edit.jpg" height="30" width="30"></a></td>';
				echo '<td>&nbsp;</td>';
				echo '<td><a href="/?page=manage&op=drop_blog&id='.$id.'" hreflang="en"><img src="/img/manage/delete.png" height="30" width="30"></a></td>';
				echo '</tr>';
			}
			echo '</table>';
			echo '<br>';
				...
				else
				{
					$ht_query = "SELECT * FROM blogs WHERE title = '$title'";
						...
						if($ht)
						{
							...
							$txt = "\nRewriteRule ^blog/$slug /?papge=blogs&op=read&id=$blog_id [L]";
							fwrite($htaccess, $txt);
							fclose($htaccess);
		...
		$mcdb = new database\db;
		 ...
		 if($result)
		 {
			 ...
			 while($row = mysqli_fetch_assoc($result))
			 {
				...
				if ($d === $module)
				{
					include 'plugins/'.$module.'/admin/manage.php';
					$finished = true;
					break;
				}
				if ($d === 'modules') {
